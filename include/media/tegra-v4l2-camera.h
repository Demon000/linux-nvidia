...
#define TEGRA_CAMERA_CID_WB_GAIN_BASE		(TEGRA_CAMERA_CID_BASE+111)

#define TEGRA_CAMERA_CID_HCG_WB_GAIN_B		(TEGRA_CAMERA_CID_WB_GAIN_BASE+0)
#define TEGRA_CAMERA_CID_HCG_WB_GAIN_Gb		(TEGRA_CAMERA_CID_WB_GAIN_BASE+1)
#define TEGRA_CAMERA_CID_HCG_WB_GAIN_Gr		(TEGRA_CAMERA_CID_WB_GAIN_BASE+2)
#define TEGRA_CAMERA_CID_HCG_WB_GAIN_R		(TEGRA_CAMERA_CID_WB_GAIN_BASE+3)

#define TEGRA_CAMERA_CID_LCG_WB_GAIN_B		(TEGRA_CAMERA_CID_WB_GAIN_BASE+4)
#define TEGRA_CAMERA_CID_LCG_WB_GAIN_Gb		(TEGRA_CAMERA_CID_WB_GAIN_BASE+5)
#define TEGRA_CAMERA_CID_LCG_WB_GAIN_Gr		(TEGRA_CAMERA_CID_WB_GAIN_BASE+6)
#define TEGRA_CAMERA_CID_LCG_WB_GAIN_R		(TEGRA_CAMERA_CID_WB_GAIN_BASE+7)

#define TEGRA_CAMERA_CID_VS_WB_GAIN_B		(TEGRA_CAMERA_CID_WB_GAIN_BASE+8)
#define TEGRA_CAMERA_CID_VS_WB_GAIN_Gb		(TEGRA_CAMERA_CID_WB_GAIN_BASE+9)
#define TEGRA_CAMERA_CID_VS_WB_GAIN_Gr		(TEGRA_CAMERA_CID_WB_GAIN_BASE+10)
#define TEGRA_CAMERA_CID_VS_WB_GAIN_R		(TEGRA_CAMERA_CID_WB_GAIN_BASE+11)

#define TEGRA_CAMERA_CID_EXP_BASE			(TEGRA_CAMERA_CID_VS_WB_GAIN_R+1)

#define TEGRA_CAMERA_CID_HCG_EXP			(TEGRA_CAMERA_CID_EXP_BASE+0)
#define TEGRA_CAMERA_CID_LCG_EXP			(TEGRA_CAMERA_CID_EXP_BASE+1)
#define TEGRA_CAMERA_CID_VS_EXP				(TEGRA_CAMERA_CID_EXP_BASE+2)

#define TEGRA_CAMERA_CID_REAL_GAIN_BASE			(TEGRA_CAMERA_CID_VS_EXP+1)

#define TEGRA_CAMERA_CID_REAL_GAIN_HCG			(TEGRA_CAMERA_CID_REAL_GAIN_BASE+0)
#define TEGRA_CAMERA_CID_REAL_GAIN_LCG			(TEGRA_CAMERA_CID_REAL_GAIN_BASE+1)
#define TEGRA_CAMERA_CID_REAL_GAIN_VS			(TEGRA_CAMERA_CID_REAL_GAIN_BASE+2)

#define TEGRA_CAMERA_CID_DIGITAL_GAIN_BASE		(TEGRA_CAMERA_CID_REAL_GAIN_VS + 1)

#define TEGRA_CAMERA_CID_DIGITAL_GAIN_HCG		(TEGRA_CAMERA_CID_DIGITAL_GAIN_BASE+0)
#define TEGRA_CAMERA_CID_DIGITAL_GAIN_LCG		(TEGRA_CAMERA_CID_DIGITAL_GAIN_BASE+1)
#define TEGRA_CAMERA_CID_DIGITAL_GAIN_VS		(TEGRA_CAMERA_CID_DIGITAL_GAIN_BASE+2)
 ...
 */
#define TEGRA_CAMERA_CID_SENSOR_MODES		(TEGRA_CAMERA_CID_BASE + 256)
